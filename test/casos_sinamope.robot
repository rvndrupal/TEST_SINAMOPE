...
Login
    ...
    recursos.Dormir  1
    recursos.Texto  (//input[contains(@type,'text')])[1]  DONOVAN GUTIERREZ
...
Descargar_pdf
    ...
    recursos.Click  (//input[contains(@type,'button')])[1]
    Dormir   1
    recursos.SLI  (//select[contains(@class,'form-control')])[4]  3
    recursos.Dormir  1
    recursos.Click  //a[contains(@id,'sinamope:dtSucursales:0:lnkSelSucursal')]
    recursos.Dormir  1
    recursos.Texto  (//input[contains(@class,'form-control')])[2]   SUCURSAL 29 COLONIA VALLEJO SUR
    recursos.Dormir  1
